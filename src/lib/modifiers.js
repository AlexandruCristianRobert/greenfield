...
export const EFFECT_TYPES = ['clickMult', 'lpsMult', 'costMult', 'releaseMult', 'tpMult']
export const BASE_MODS = Object.freeze({ clickMult: 1, lpsMult: 1, costMult: 1, releaseMult: 1, tpMult: 1 })
